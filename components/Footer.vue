<template>
  <footer class="footer">
      ...
      <div class="offcanvas-body">
        <ul class="menu">
          ...
          >
            ...
            >
              <img :src="`/images/navbar/${item.image}`" alt="" width="50" />
    ...
    <div class="container">
      ...
      <button
        class="footer-item btn shadow-none"
...
export default {
  data() {
    return {
      menuItems: [
        { id: 1, label: "Login", link: "/login", image: "login-image.jpg" },
        {
          id: 2,
          label: "শিক্ষক তালিকা",
          link: "/teachers",
        ...
        },
        {
          ...
          image: "teacher-attendance.png",
        },
        {
          id: 11,
          label: "স্টুডেন্ট রেজিস্ট্রার",
        ...
        { id: 5, label: "নোটিশ", link: "/notice", image: "bell.png" },
        { id: 6, label: "নোট", link: "/note", image: "pencil.png" },
        {
          id: 6,
          label: "বেতন হিস্টোরি",
