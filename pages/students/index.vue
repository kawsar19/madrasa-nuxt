    ...
    <div class="container">
        ...
        <ul v-if="!isContentLoading" class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between align-items-center" v-for="student in students"
                ...
                <span>
                    ...
                    <span data-bs-toggle="modal" data-bs-target="#setSalleryModal" @click="showModal(student)">
        ...
        <div v-else class="">
            <div class="list-group mb-3">
                <div class="list-group-item d-flex justify-content-between align-items-center skeleton-item" v-for="n in 5"
                    :key="n">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="payment in selectedStudent.payments" :key="payment._id">
                                        <td>{{ payment.month }}</td>
                                        <td>{{ payment.year }}</td>
        ...
        <!-- set payment  -->
        <div class="modal fade" id="setSalleryModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                            @click="clickCancel">Close</button>
                        <button type="button" class="btn btn-primary" @click="saveMonthlyFee">Save</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    methods: {
        ...
        async submitPayment() {
            ...
            try {
                ...
                const response = await axios.post(`http://localhost:5000/api/student/create-payment/${this.payment.student}`, this.payment, {
                    headers: {
        ...
        async fetchClassess() {
            try {
                ...
                const response = await axios.get('http://localhost:5000/api/class/list', { headers });
        ...
        saveMonthlyFee() {
            ...
            const apiUrl = `http://localhost:5000/api/student/set-monthly-fee/${this.selectedStudent._id}`;
