  ...
  <div class="container">
    ...
    <div v-else class="position-relative mt-5">
      <div class="d-flex align-items-end justify-content-between">
        <h5 class="fw-bold">
          স্বাগতম
          <span id="teacherName" class="text-danger">{{ teacherName }}</span>
        </h5>
        <img
          :src="userImage"
          height="60"
          width="60"
          class="rounded-circle border-6"
          alt=""
        />
      </div>
      ...
      <div class="dashboard">
        <div class="row g-4">
          <div class="col-sm-6 col-md-4">
            <div
              class="info-card teachers"
              @click="window.location.href = '/teacher/student-list.html'"
            >
              <h2 class="card-title">মোট ক্লাশ</h2>
          ...
          <div class="col-sm-6 col-md-4">
            <div
              ...
              @click="window.location.href = '/teacher/student-list.html'"
            >
              <h2 class="card-title">মোট শিক্ষক</h2>
...
export default {
  ...
  methods: {
    ...
    fetchData(madrasa) {
      ...
      this.$axios
        .get(`/madrasa/totalcount/${madrasa}`, {
          headers: {
